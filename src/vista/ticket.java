...
public class ticket extends javax.swing.JFrame {
    ...
    void listar(){
        ...
        try {
            ...
            Object[]ticket=new Object[5];
            modelo=(DefaultTableModel) tabladatos.getModel();
            while (rs.next()){
                ticket[0]=rs.getInt("id");
                ticket[1]=rs.getString("Dia");
                ticket[2]=rs.getString("Mes");
                ticket[3]=rs.getInt("Año");
    ...
    void Agregar(){
        ...
        if(dia.equals("")||mes.equals("")){
            ...
            String sql="insert into tickets(dia_ticket,mes_ticket,año_ticket)values('"+dia+"','"+mes+"','"+año+"')";
    ...
    void Modificar() {
       String dia= txtdia.getText();
        String mes= txtmes.getText();
        String año = txtaño.getText();
        String sql = "update tickets set Dia='" + dia + "',Mes='" + mes + "',año='" + año + "' where Id=" + id;
        try {
